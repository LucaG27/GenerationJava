...
public class Regione {
	...
	public Regione() {
		...
		public Regione(int id, String regione, String comune, int maschi, int femmine, int totale) {
		super();
		this.id = id;
	...
	public String toString() {
		return "Regione [id=" + id + ", regione=" + regione + ", comune=" + comune + ", maschi=" + maschi + ", femmine="
