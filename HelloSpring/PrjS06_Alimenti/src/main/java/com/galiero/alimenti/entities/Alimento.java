package com.galiero.alimenti.entities;
...
@Entity
@Table(name="alimenti") // -> Perchè la classe Alimento non coincide con la tabella alimenti altrimenti la prende di default
